...
values
  ('d1000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000001', '25120', 3, 45, 1, 11.28),
  ('d1000000-0000-0000-0000-000000000002', 'b1000000-0000-0000-0000-000000000001', '25120', 3, 46, 1, 9.40),
  ('d1000000-0000-0000-0000-000000000003', 'b1000000-0000-0000-0000-000000000003', '17195', 4, 22, 1, 18.60),
  ('d1000000-0000-0000-0000-000000000004', 'b1000000-0000-0000-0000-000000000003', '17195', 4, 22, 2, 7.90),
  ('d1000000-0000-0000-0000-000000000005', 'b1000000-0000-0000-0000-000000000004', '25110', 7, 13, 1, 22.75),
  ('d1000000-0000-0000-0000-000000000006', 'b1000000-0000-0000-0000-000000000004', '25110', 7, 14, 1, 14.20),
  ('d1000000-0000-0000-0000-000000000007', 'b1000000-0000-0000-0000-000000000006', '25210', 2, 88, 1, 33.50),
  ('d1000000-0000-0000-0000-000000000008', 'b1000000-0000-0000-0000-000000000006', '25210', 2, 89, 1, 12.40),
  ('d1000000-0000-0000-0000-000000000009', 'b1000000-0000-0000-0000-000000000008', '17079', 5, 9, 1, 16.80),
  ('d1000000-0000-0000-0000-000000000010', 'b1000000-0000-0000-0000-000000000008', '17079', 5, 9, 2, 13.10),
  ('d1000000-0000-0000-0000-000000000011', 'b1000000-0000-0000-0000-000000000010', '08215', 1, 31, 1, 10.25),
  ('d1000000-0000-0000-0000-000000000012', 'b1000000-0000-0000-0000-000000000010', '08215', 1, 32, 1, 8.70)
on conflict (id) do update set
  titular_id = excluded.titular_id,
...
values
  ('11000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-000000000001', 'd1000000-0000-0000-0000-000000000001', '2024-03-12', 280.00, 52.00, 'c1000000-0000-0000-0000-000000000004'),
  ('11000000-0000-0000-0000-000000000002', 'e1000000-0000-0000-0000-000000000001', 'd1000000-0000-0000-0000-000000000002', '2024-05-10', 145.00, 24.00, 'c1000000-0000-0000-0000-000000000004'),
  ('11000000-0000-0000-0000-000000000003', 'e1000000-0000-0000-0000-000000000002', 'd1000000-0000-0000-0000-000000000001', '2025-02-18', 310.00, 58.00, 'c1000000-0000-0000-0000-000000000004'),
  ('11000000-0000-0000-0000-000000000004', 'e1000000-0000-0000-0000-000000000002', 'd1000000-0000-0000-0000-000000000002', '2025-04-09', 175.00, 29.50, 'c1000000-0000-0000-0000-000000000006'),

  ('11000000-0000-0000-0000-000000000005', 'e1000000-0000-0000-0000-000000000005', 'd1000000-0000-0000-0000-000000000003', '2024-03-22', 420.00, 78.00, 'c1000000-0000-0000-0000-000000000004'),
  ('11000000-0000-0000-0000-000000000006', 'e1000000-0000-0000-0000-000000000005', 'd1000000-0000-0000-0000-000000000004', '2024-06-14', 120.00, 18.00, 'c1000000-0000-0000-0000-000000000004'),
  ('11000000-0000-0000-0000-000000000007', 'e1000000-0000-0000-0000-000000000006', 'd1000000-0000-0000-0000-000000000003', '2025-03-05', 455.00, 82.00, 'c1000000-0000-0000-0000-000000000006'),

  ('11000000-0000-0000-0000-000000000008', 'e1000000-0000-0000-0000-000000000007', 'd1000000-0000-0000-0000-000000000005', '2025-02-11', 510.00, 91.00, 'c1000000-0000-0000-0000-000000000008'),
  ('11000000-0000-0000-0000-000000000009', 'e1000000-0000-0000-0000-000000000007', 'd1000000-0000-0000-0000-000000000006', '2025-04-16', 280.00, 44.00, 'c1000000-0000-0000-0000-000000000007'),

  ('11000000-0000-0000-0000-000000000010', 'e1000000-0000-0000-0000-000000000009', 'd1000000-0000-0000-0000-000000000007', '2025-03-01', 350.00, 60.00, 'c1000000-0000-0000-0000-000000000008'),
  ('11000000-0000-0000-0000-000000000011', 'e1000000-0000-0000-0000-000000000009', 'd1000000-0000-0000-0000-000000000008', '2025-05-20', 140.00, 22.00, 'c1000000-0000-0000-0000-000000000008'),

  ('11000000-0000-0000-0000-000000000012', 'e1000000-0000-0000-0000-000000000011', 'd1000000-0000-0000-0000-000000000009', '2024-03-19', 230.00, 41.00, 'c1000000-0000-0000-0000-000000000004'),
  ('11000000-0000-0000-0000-000000000013', 'e1000000-0000-0000-0000-000000000011', 'd1000000-0000-0000-0000-000000000010', '2024-06-02', 180.00, 31.00, 'c1000000-0000-0000-0000-000000000006'),
  ('11000000-0000-0000-0000-000000000014', 'e1000000-0000-0000-0000-000000000012', 'd1000000-0000-0000-0000-000000000009', '2025-02-27', 245.00, 45.00, 'c1000000-0000-0000-0000-000000000006'),
  ('11000000-0000-0000-0000-000000000015', 'e1000000-0000-0000-0000-000000000012', 'd1000000-0000-0000-0000-000000000010', '2025-04-24', 195.00, 34.00, 'c1000000-0000-0000-0000-000000000004'),

  ('11000000-0000-0000-0000-000000000016', 'e1000000-0000-0000-0000-000000000014', 'd1000000-0000-0000-0000-000000000011', '2025-03-03', 160.00, 26.00, 'c1000000-0000-0000-0000-000000000008'),
  ('11000000-0000-0000-0000-000000000017', 'e1000000-0000-0000-0000-000000000014', 'd1000000-0000-0000-0000-000000000012', '2025-05-06', 145.00, 23.00, 'c1000000-0000-0000-0000-000000000007')
on conflict (id) do update set
