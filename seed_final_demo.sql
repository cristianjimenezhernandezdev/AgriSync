...
insert into public.aplicacions_fertilitzants (id, dan_id, terra_id, data, tipus_fertilitzant, procedencia, volum_m3, kg_n_m3, kg_n, uf, tecnic_id)
values
  ('11000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-000000000001', 'd1000000-0000-0000-0000-000000000001', '2024-03-12', 'Purí porcí', 'Granja propia de referencia', 26.00, 10.77, 280.00, 52.00, 'c1000000-0000-0000-0000-000000000004'),
  ('11000000-0000-0000-0000-000000000002', 'e1000000-0000-0000-0000-000000000001', 'd1000000-0000-0000-0000-000000000002', '2024-05-10', 'Fems bovins', 'Aportacio organica interna', 18.00, 8.06, 145.00, 24.00, 'c1000000-0000-0000-0000-000000000004'),
  ('11000000-0000-0000-0000-000000000003', 'e1000000-0000-0000-0000-000000000002', 'd1000000-0000-0000-0000-000000000001', '2025-02-18', 'Purí porcí', 'Granja origen declarada pel titular', 28.50, 10.88, 310.00, 58.00, 'c1000000-0000-0000-0000-000000000004'),
  ('11000000-0000-0000-0000-000000000004', 'e1000000-0000-0000-0000-000000000002', 'd1000000-0000-0000-0000-000000000002', '2025-04-09', 'Adob mineral', 'Compra externa', null, null, 175.00, 29.50, 'c1000000-0000-0000-0000-000000000006'),

  ('11000000-0000-0000-0000-000000000005', 'e1000000-0000-0000-0000-000000000005', 'd1000000-0000-0000-0000-000000000003', '2024-03-22', 'Purí boví', 'Recepcio de granja vinculada', 35.00, 12.00, 420.00, 78.00, 'c1000000-0000-0000-0000-000000000004'),
  ('11000000-0000-0000-0000-000000000006', 'e1000000-0000-0000-0000-000000000005', 'd1000000-0000-0000-0000-000000000004', '2024-06-14', 'Adob mineral', 'Compra externa', null, null, 120.00, 18.00, 'c1000000-0000-0000-0000-000000000004'),
  ('11000000-0000-0000-0000-000000000007', 'e1000000-0000-0000-0000-000000000006', 'd1000000-0000-0000-0000-000000000003', '2025-03-05', 'Purí boví', 'Recepcio declarada campanya 2025', 37.00, 12.30, 455.00, 82.00, 'c1000000-0000-0000-0000-000000000006'),

  ('11000000-0000-0000-0000-000000000008', 'e1000000-0000-0000-0000-000000000007', 'd1000000-0000-0000-0000-000000000005', '2025-02-11', 'Gallinassa', 'Cooperativa propia', 22.00, 23.18, 510.00, 91.00, 'c1000000-0000-0000-0000-000000000008'),
  ('11000000-0000-0000-0000-000000000009', 'e1000000-0000-0000-0000-000000000007', 'd1000000-0000-0000-0000-000000000006', '2025-04-16', 'Purí porcí', 'Recepcio interna', 24.00, 11.67, 280.00, 44.00, 'c1000000-0000-0000-0000-000000000007'),

  ('11000000-0000-0000-0000-000000000010', 'e1000000-0000-0000-0000-000000000009', 'd1000000-0000-0000-0000-000000000007', '2025-03-01', 'Purí porcí', 'Granja de suport', 30.00, 11.67, 350.00, 60.00, 'c1000000-0000-0000-0000-000000000008'),
  ('11000000-0000-0000-0000-000000000011', 'e1000000-0000-0000-0000-000000000009', 'd1000000-0000-0000-0000-000000000008', '2025-05-20', 'Adob mineral', 'Compra externa', null, null, 140.00, 22.00, 'c1000000-0000-0000-0000-000000000008'),

  ('11000000-0000-0000-0000-000000000012', 'e1000000-0000-0000-0000-000000000011', 'd1000000-0000-0000-0000-000000000009', '2024-03-19', 'Purí porcí', 'Titular receptor habitual', 20.00, 11.50, 230.00, 41.00, 'c1000000-0000-0000-0000-000000000004'),
  ('11000000-0000-0000-0000-000000000013', 'e1000000-0000-0000-0000-000000000011', 'd1000000-0000-0000-0000-000000000010', '2024-06-02', 'Adob mineral', 'Compra externa', null, null, 180.00, 31.00, 'c1000000-0000-0000-0000-000000000006'),
  ('11000000-0000-0000-0000-000000000014', 'e1000000-0000-0000-0000-000000000012', 'd1000000-0000-0000-0000-000000000009', '2025-02-27', 'Purí porcí', 'Recepcio des de granja propera', 21.00, 11.67, 245.00, 45.00, 'c1000000-0000-0000-0000-000000000006'),
  ('11000000-0000-0000-0000-000000000015', 'e1000000-0000-0000-0000-000000000012', 'd1000000-0000-0000-0000-000000000010', '2025-04-24', 'Adob mineral', 'Compra externa', null, null, 195.00, 34.00, 'c1000000-0000-0000-0000-000000000004'),

  ('11000000-0000-0000-0000-000000000016', 'e1000000-0000-0000-0000-000000000014', 'd1000000-0000-0000-0000-000000000011', '2025-03-03', 'Fems bovins', 'Ramaderia propia', 16.00, 10.00, 160.00, 26.00, 'c1000000-0000-0000-0000-000000000008'),
  ('11000000-0000-0000-0000-000000000017', 'e1000000-0000-0000-0000-000000000014', 'd1000000-0000-0000-0000-000000000012', '2025-05-06', 'Adob mineral', 'Compra externa', null, null, 145.00, 23.00, 'c1000000-0000-0000-0000-000000000007')
on conflict (id) do update set
