...
- `composeApp/branding/icons/app-icon.ico`
  Per Windows `MSI`
- `composeApp/branding/icons/app-icon.icns`
  Per macOS `DMG`
...
- Si canvies de `svg` a `png`, elimina l'anterior.

## 2. Que ja queda preparat al projecte

- La finestra desktop carrega `Res.drawable.app_icon`
- El paquet Windows mira `branding/icons/app-icon.ico`
- El paquet macOS mira `branding/icons/app-icon.icns`
- El paquet Linux mira `branding/icons/app-icon.png`
...
1. `composeApp/src/jvmMain/composeResources/drawable/app-icon.svg`
2. `composeApp/branding/icons/app-icon.ico`

Opcional si algun dia vols empaquetar per altres sistemes:

1. `composeApp/branding/icons/app-icon.icns`
2. `composeApp/branding/icons/app-icon.png`
